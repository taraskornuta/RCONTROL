...
{
	TIM3->CCR1 = (uint16_t)(coeff * ch[0]);
	TIM3->CCR2 = (uint16_t)(coeff * ch[1]);
	TIM3->CCR3 = (uint16_t)(coeff * ch[2]);
	TIM3->CCR4 = (uint16_t)(coeff * ch[3]);
	TIM2->CCR1 = (uint16_t)(coeff * ch[4]);
	TIM2->CCR2 = (uint16_t)(coeff * ch[5]);
	TIM2->CCR3 = (uint16_t)(coeff * ch[6]);
	TIM2->CCR4 = (uint16_t)(coeff * ch[7]);
}
